...
# 2.Parameterize in feature file:
...
@pytest.mark.parametrize("test_data", get_csv_data(r"C:\Users\amitd.sharma_infobea\PycharmProjects\AutomationProject1\config.csv"))
